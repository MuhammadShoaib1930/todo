...
class EditeDialog  {
  EditeDialog(context,int index,String title, String content) {
  ...
  showDialog(
    ...
    builder: (context) {
      ...
      contantController.text = content;
      return AlertDialog(
        title: Center(child: Text("Editing Task")),
        content: SizedBox(
          height: 200,
          child: Center(
            child: Column(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async{
              ...
              TodoServers().edited(index: index,title: titleController.text.toString(),content: contantController.text.toString());
